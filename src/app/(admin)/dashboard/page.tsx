...
const Dashboard = () => {
  ...
  const stats = [
    ...
    {
      title: 'Data Kaos Kaki Baru Bulan Ini',
      value: '10',
      icon: BarChart3,
      change: '+5',
      isPositive: true,
                ...
                <CardContent>
                  <div className='h-64 flex items-center justify-center bg-gray-50 rounded-lg border border-gray-200'>
                    <div className='text-center'>
                      <div className='text-4xl font-bold text-gray-900 mb-2'>$87,432</div>
                      <p className='text-gray-600'>Chart placeholder - integrate with your charting library</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
