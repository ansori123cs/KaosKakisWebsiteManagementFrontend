...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validasi
    if (!formData.fullName || !formData.nik || !formData.telp || !formData.username || !formData.password || !formData.alamat) {
      ...
      <Card className='mb-6 w-full max-w-2xl bg-white rounded-2xl p-1 mt-2'>
        <CardContent className='pt-6'>
          ...
          <div className='text-center mb-8'>
            <h1 className='text-3xl font-bold text-gray-900 mb-2'>Registrasi</h1>
          </div>
            ...
            <CardContent className='pt-6'>
              <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <div className='flex items-start gap-2'>
                  <input id='agreeTerms' name='agreeTerms' type='checkbox' checked={formData.agreeTerms} onChange={handleChange} className='mt-1 rounded border-gray-300' />
                  <label htmlFor='agreeTerms' className='text-sm text-gray-600'>
                    Saya setuju dengan{' '}
                    <Link href='#' className='text-persebaya-link underline hover:text-blue-700 font-medium'>
                      Syarat & Ketentuan
                    </Link>{' '}
                    dan{' '}
                    <Link href='#' className='text-persebaya-link underline hover:text-blue-700 font-medium'>
          ...
          <div className='text-start'>
            <p className='text-gray-600 text-sm'>
              Sudah punya akun?{' '}
              <Link href='/login' className='text-persebaya-link underline hover:text-blue-700 font-semibold'>
                Masuk di sini
              </Link>
            </p>
          </div>
