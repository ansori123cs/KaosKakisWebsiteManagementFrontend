    ...
    <nav className='fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-40 flex items-center  px-4 md:px-6 shadow-sm'>
      ...
      <div className='w-full flex justify-between'>
        ...
        <div className='flex items-center gap-4'>
          <Button variant='ghost' size='sm' onClick={toggleSidebar} className='md:p-2'>
            <Menu className='w-5 h-5' />
          </Button>
          <Link href='/' className='flex items-center gap-2 font-bold text-xl '>
            <div className='w-10 h-10 p-3 bg-blue-500 rounded-lg flex items-center justify-center text-white font-bold'>CN</div>
            <span className='hidden md:inline'>Corporate Name</span>
          </Link>
        </div>
